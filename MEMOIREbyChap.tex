...
This chapter will focus only on GEV analysis on annual maxima. Extension to POT or Point Processes is straightforward with tools provided in both text and code.

In \hyperref[sec:returnlvlnstatio]{Section \textbf{\ref{sec:returnlvlnstatio}}} we will, 7
Useful tools regarding Bayesian inference are let in \hyperref[appB]{Appendix \textbf{\ref{appB}}}.


This chapter is mostly based on \citet[sec. 9.1]{coles_introduction_2001}, \citet[chap.11]{beirlant_statistics_2006} and \cite[chap.13]{dey_extreme_2016}, and other relevant articles.
