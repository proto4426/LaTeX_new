...
This chapter will focus on another major approach of EV models by modeling only the excess over certain a threshold. This approach is very popular in practice as it handles extremes with more flexibility and hence lots of methods have emerged. 	
