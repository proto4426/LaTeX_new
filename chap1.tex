...
We can now try to visually represent these three families. The following Figure \ref{gevdens} depicts the density distribution of the GEV, defined with respect to the value of the shape parameter $\xi$. 
