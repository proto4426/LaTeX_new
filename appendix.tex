...
\begin{figure}[!htb]
	\centering	\includegraphics[width=.7\linewidth]{ppqq_trans.pdf}\caption{(left) Residual probability plot and probability. (right) Residual quantile plot on the Gumbel scale. Both for the nonstationary GEV model allowing for a linear trend in the location parameter and fitted by MLE.}\label{fig:ppqqplot2}
\end{figure}
